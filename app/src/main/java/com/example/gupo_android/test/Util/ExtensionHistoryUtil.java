...
public class ExtensionHistoryUtil {
    ...
    public static void setExtensionBarState(Context context, String id, Conversation.ConversationType conversationType, ExtensionHistoryUtil.ExtensionBarState state) {
    ...
    public static ExtensionHistoryUtil.ExtensionBarState getExtensionBarState(Context context, String id, Conversation.ConversationType conversationType) {
        if (enableHistory && !sExceptConversationTypes.contains(conversationType)) {
            SharedPreferences sp = context.getSharedPreferences("RongKitConfig", 0);
